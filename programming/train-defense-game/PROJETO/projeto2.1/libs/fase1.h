...
/************************************************************************************////
        ...
        //////////////////////////////////////////////////////////////////////
                 ...
                 if(cont_tempo<300)/*10800)*/ /// vai se mexer pra cima do personagem enquanto o tempo for menor que 3min
                 {
        ...
        //////////////////////////////////////////////////////////////////////
                 ...
                 if(cont_tempo%200==0 && cont_tempo<300)/*10800)*/   /// soltador de inimigos só solta qndo for menor que 3min.
                 {
                    if(inimigo_delay==0)
                    {
                       for(i=0;i<10;i++)
                 ...
                 if(cont_tempo>300 && boss.estado==EST_INATIVO && BOSS_DEAD==EST_ATIVO)
                 {
                    estacao.estado = EST_ATIVO;
                 }
                 if(cont_tempo>300 && estacao.estado==EST_INATIVO)//10800)
                 {
                    for(i=0;i<10;i++)
                    {
