...
bool iniciaVariable(){
   ...
   al_set_new_display_flags(ALLEGRO_WINDOWED);      ///** Inicialize FULLSCREEN
   ...
   imageBDiscard = al_load_bitmap("image/descarte.png");
   imageGetCor = al_load_bitmap("image/mudarCor.png");
   amarelo = al_load_bitmap("image/amarelo.png");
   azul = al_load_bitmap("image/azul.png");
   vermelho = al_load_bitmap("image/vermelho.png");
   verde = al_load_bitmap("image/verde.png");
